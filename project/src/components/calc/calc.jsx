...
function Calc() {
  ...
  const incrementCounter = () => setCounter(counter + 100000);
  let decrement = () => setCounter(counter - 100000);
          ...
          <div className="calc__container">
            <div className="calc__case">
              ...
              <div className="calc__wrapper">
                ...
                <Display counter={counter} onChange={setCounter} decrement={decrement}/>
